...
<xsl:stylesheet version="1.0"
	...
	<xd:doc scope="stylesheet">
		<xd:desc>
			...
			<xd:p><xd:b>Edited on:</xd:b> Jan 27, 2022 (generating link for CMDI Explorer)</xd:p>
			...
			<body>
				...
				<div id="tabs">
					<ul>
						...
						<li>
							<a href="#tabs-7">Resource-specific Info</a>
						</li>
						<li>
						...
						<li>
							<a href="#tabs-10">Citation</a>
						</li>
						<li>
							<a href="#tabs-11">Report violation</a>
						</li>
					...
					<tr>
						...
						<td>
						  <xsl:element name="a">
						    ...
						    <xsl:attribute name="href">
						      https://weblicht.sfs.uni-tuebingen.de/CMDIExplorer/#/talar/<xsl:call-template name="url-encode">
